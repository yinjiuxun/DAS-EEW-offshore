...
test_event_id =  9001 #9001, 9006
show_loc = 1 # 1: show location 1; 2: show location 2; 3: show both location
...
if show_loc == 3:
    fig_output_dir += f'/{test_event_id}_both'
elif (show_loc == 1) or (show_loc == 2):
    fig_output_dir += f'/{test_event_id}_loc{show_loc}'
else:
    raise ValueError('show_loc must be 1, 2, 3!')
mkdir(fig_output_dir)
...
strain_rate= strain_rate[:, ii_channel]
